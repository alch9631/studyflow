...
- [ ] (cleanup) Remove stray `console.log` calls across src/ (keep intentional console.error in error paths) and update the outdated AI model ids in src/lib/syllabus.ts to current models. No behaviour change beyond logging hygiene; keep the env-gated AI no-op intact.
