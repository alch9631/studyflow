...
const en = {
  ...
  today: {
    ...
    statusOver: "Today holds about {time} more than fits — that's okay.",
    ...
    sheetReview: "🔁 Review",
    // ── Energy of the day (client-only reorder of the study queue) ──
    energyLabel: "Energy",
    energyLow: "Low",
    energyNormal: "Normal",
    energyHigh: "High",
    energyAria: "How much energy do you have right now?",
    energyHintHigh: "Hardest, longest sessions first.",
    energyHintLow: "Short and review sessions first.",
    energyHintNormal: "Your planned order.",
    // ── Focus mode entry + explain/catch-up entry points ──
    focusOpen: "Focus mode",
    explainOpen: "Why this plan?",
    crunchOpen: "Help me catch up",
  },
  panic: {
    // Calm catch-up triage — derived ONLY from the user's own data.
    title: "Catch up",
    subtitle: "{course} is in {days} days and there's more planned than time. Here's a calm, focused way through it.",
    open: "Help me catch up",
    close: "Close",
    mvpTitle: "Do these first",
    mvpHint: "The highest-priority topics by exam proximity and effort — start at the top.",
    skimTitle: "Skim or skip if pressed",
    skimHint: "Short or already-confident topics. Touch them only once the must-dos are solid.",
    practiceTitle: "Practice first",
    practiceBody: "When time is short, recall beats re-reading. Do problems and past questions on the must-do topics before adding new material.",
    respreadCta: "Respread to fit the days left",
    respreadHint: "Rebuilds the plan across the days before each exam. Finished work stays done.",
    nothingTitle: "Nothing to triage",
    nothingBody: "You're caught up for today — nothing extra needed.",
    minLabel: "{time}",
    confidentTag: "✓ confident",
  },
  focus: {
    title: "Focus",
  ...
  courses: {
    ...
    emptyDescActionable: "Start with your TUHH module catalog or import a syllabus — we turn it into a day-by-day plan.",
  ...
  insights: {
    ...
    emptyDesc:
      "Add a course and log a session or two — your rhythm shows up here.",
...
const de: Messages = {
  ...
  today: {
    ...
    statusOver: "Heute ist etwa {time} mehr geplant als passt — das ist okay.",
    ...
    // ── Energie des Tages (rein clientseitiges Umsortieren der Lern-Liste) ──
    energyLabel: "Energie",
    energyLow: "Wenig",
    energyNormal: "Normal",
    energyHigh: "Viel",
    energyAria: "Wie viel Energie hast du gerade?",
    energyHintHigh: "Die schwersten, längsten Einheiten zuerst.",
    energyHintLow: "Kurze Einheiten und Wiederholungen zuerst.",
    energyHintNormal: "Deine geplante Reihenfolge.",
    // ── Fokusmodus + Einstiege für Erklärung/Aufholen ──
    focusOpen: "Fokusmodus",
    explainOpen: "Warum dieser Plan?",
    crunchOpen: "Hilf mir aufzuholen",
  },
  panic: {
    // Ruhiges Aufhol-Triage — ausschließlich aus den eigenen Daten abgeleitet.
    title: "Aufholen",
    subtitle: "{course} ist in {days} Tagen und es ist mehr geplant als Zeit da ist. Hier ist ein ruhiger, fokussierter Weg hindurch.",
    open: "Hilf mir aufzuholen",
    close: "Schließen",
    mvpTitle: "Das zuerst",
    mvpHint: "Die wichtigsten Themen nach Prüfungsnähe und Aufwand — fang oben an.",
    skimTitle: "Überfliegen oder weglassen, wenn's eng wird",
    skimHint: "Kurze oder schon sichere Themen. Erst anfassen, wenn das Wichtigste sitzt.",
    practiceTitle: "Erst üben",
    practiceBody: "Wenn die Zeit knapp ist, bringt aktives Abrufen mehr als erneutes Lesen. Rechne Aufgaben und Altklausuren zu den Muss-Themen, bevor du Neues dazunimmst.",
    respreadCta: "Auf die verbleibenden Tage neu verteilen",
    respreadHint: "Baut den Plan über die Tage vor jeder Prüfung neu auf. Erledigtes bleibt erledigt.",
    nothingTitle: "Nichts zu priorisieren",
    nothingBody: "Du bist für heute auf dem Stand — nichts Zusätzliches nötig.",
    minLabel: "{time}",
    confidentTag: "✓ sicher",
  },
  focus: {
  ...
  courses: {
    ...
    emptyDescActionable: "Starte mit dem TUHH-Modulkatalog oder importiere einen Lehrplan — wir machen daraus einen Tagesplan.",
  ...
  insights: {
    ...
    emptyDesc:
      "Füge einen Kurs hinzu und hak ein, zwei Einheiten ab — dein Rhythmus erscheint hier.",
