...
const en = {
  ...
  today: {
    ...
    // ── Focus mode entry + explain/crunch entry points ──
    focusOpen: "Focus mode",
    explainOpen: "Why this plan?",
    crunchOpen: "Crunch mode",
  },
  panic: {
    // Calm crunch-mode triage — derived ONLY from the user's own data.
    title: "Crunch mode",
    subtitle: "{course} is in {days} days and there's more planned than time. Here's a calm, focused way through it.",
    open: "Open crunch mode",
    close: "Close",
    ...
    nothingBody: "You're caught up for today — no crunch needed.",
    minLabel: "{time}",
  ...
  courses: {
    ...
    whyUntouched: { one: "{count} topic untouched", other: "{count} topics untouched" },
...
const de: Messages = {
  ...
  today: {
    ...
    // ── Fokusmodus + Einstiege für Erklärung/Endspurt ──
    focusOpen: "Fokusmodus",
    explainOpen: "Warum dieser Plan?",
    crunchOpen: "Endspurt-Modus",
  },
  panic: {
    // Ruhiger Endspurt-Modus — ausschließlich aus den eigenen Daten abgeleitet.
    title: "Endspurt-Modus",
    subtitle: "{course} ist in {days} Tagen und es ist mehr geplant als Zeit da ist. Hier ist ein ruhiger, fokussierter Weg hindurch.",
    open: "Endspurt-Modus öffnen",
    close: "Schließen",
    mvpTitle: "Das zuerst",
    ...
    nothingBody: "Du bist für heute auf dem Stand — kein Endspurt nötig.",
    minLabel: "{time}",
    confidentTag: "✓ sicher",
  },
  focus: {
  ...
  courses: {
    ...
    whyUntouched: { one: "{count} Thema offen", other: "{count} Themen offen" },
