...
const en = {
  ...
  block: {
    ...
    ratePrompt: "How hard was it?",
    rateGroupLabel: "Rate how hard this session was",
    rateEasy: "Easy",
    rateMedium: "Medium",
    rateHard: "Hard",
    rateEasyAria: "Rate this session easy",
    rateMediumAria: "Rate this session medium",
    rateHardAria: "Rate this session hard",
    rateSaved: "Thanks — we'll weight your reviews by this.",
...
const de: Messages = {
  ...
  block: {
    ...
    ratePrompt: "Wie schwer war's?",
    rateGroupLabel: "Bewerte, wie schwer diese Einheit war",
    rateEasy: "Leicht",
    rateMedium: "Mittel",
    rateHard: "Schwer",
    rateEasyAria: "Diese Einheit als leicht bewerten",
    rateMediumAria: "Diese Einheit als mittel bewerten",
    rateHardAria: "Diese Einheit als schwer bewerten",
    rateSaved: "Danke — wir gewichten deine Wiederholungen danach.",
