...
const en = {
  ...
  landing: {
    ...
    heroTitlePre: "A daily study plan that ",
    heroTitleHighlight: "builds itself",
    heroTitlePost: " from your exam dates.",
    heroSubtitle:
      "For TUHH students: pick your modules, get exactly what to study today.",
    ...
    stat3Value: "Daily",
    stat3Label: "plan, ready each morning",
    featuresTitle: "What it does",
    featuresSubtitle: "Plan, timetable, exams, progress — in one place.",
    feat1Title: "Builds itself",
    feat1Body: "A daily plan, backward from each exam date.",
    feat2Title: "Heals when you slip",
    feat2Body: "One tap re-plans around what's still undone.",
    feat3Title: "Made to stick",
    feat3Body: "Spaced reviews and self-tests, built in.",
    feat4Title: "See it working",
    feat4Body: "Streaks, consistency, GPA and credits.",
    proofTitle: "Built for exam season",
    proofSubtitle: "Early testers turned a stack of modules into one daily routine.",
    quote1: "The morning plan tells me what to study, and I just do it.",
    quote1Author: "Engineering student",
    quote1Detail: "Exam-season tester",
    quote2: "Missing a few days used to wreck my schedule. Now I re-plan in a tap.",
    quote2Author: "Second-year student",
    quote2Detail: "Early access",
    quote3: "Watching the streak climb keeps me honest.",
    ...
    ctaSubtitle: "Add your modules — get a plan for tomorrow morning.",
...
const de: Messages = {
  ...
  landing: {
    ...
    heroTitlePost: " — aus deinen Prüfungsterminen.",
    heroSubtitle:
      "Für TUHH-Studierende: Module wählen, sehen, was heute dran ist.",
    buildPlan: "Plan erstellen",
    havePlan: "Ich habe schon einen Plan",
    stat1Value: "0",
    stat1Label: "Tabellen",
    stat2Value: "1 Tipp",
    stat2Label: "für eine schlechte Woche neu",
    stat3Value: "Täglich",
    stat3Label: "Plan, jeden Morgen bereit",
    featuresTitle: "Was es macht",
    featuresSubtitle: "Plan, Stundenplan, Prüfungen, Fortschritt — an einem Ort.",
    feat1Title: "Baut sich selbst auf",
    feat1Body: "Ein Tagesplan, rückwärts von jedem Prüfungstermin.",
    feat2Title: "Repariert sich, wenn du rauskommst",
    feat2Body: "Ein Tipp plant rund um das Offene neu.",
    feat3Title: "Bleibt hängen",
    feat3Body: "Verteilte Wiederholungen und Selbsttests, eingebaut.",
    feat4Title: "Sieh, wie es wirkt",
    feat4Body: "Serien, Beständigkeit, Notenschnitt und Punkte.",
    proofTitle: "Gebaut für die Prüfungszeit",
    proofSubtitle: "Erste Tester:innen machten aus einem Stapel Module eine Tagesroutine.",
    quote1: "Der Morgenplan sagt mir, was zu lernen ist, und ich mach's einfach.",
    quote1Author: "Ingenieurstudent",
    quote1Detail: "Tester in der Prüfungszeit",
    quote2: "Verpasste Tage haben früher meinen Plan ruiniert. Jetzt plane ich mit einem Tipp neu.",
    quote2Author: "Studentin im zweiten Jahr",
    quote2Detail: "Früher Zugang",
    quote3: "Die Serie steigen zu sehen, hält mich ehrlich.",
    ...
    ctaSubtitle: "Module hinzufügen — Plan für morgen früh bekommen.",
